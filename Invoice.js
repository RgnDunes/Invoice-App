const Invoice = ({ invoicesData, setInvoices, itemsData, customersData }) => {
  const [newInvoiceShow, setNewInvoiceShow] = React.useState(false);
  const [customerChosen, setCustomerChosen] = React.useState(false);
  const [customer, setCustomer] = React.useState("");
  const [issueDate, setIssueDate] = React.useState("");
  const [dueDate, setDueDate] = React.useState("");
  const [items, setItems] = React.useState([]);
  const [itemAdded, setItemAdded] = React.useState("");
  const [itemChosing, setItemChosing] = React.useState(false);
  ...
  const handleSubmit = (e) => {
    ...
    setInvoices(val);
    setNewInvoiceShow(!newInvoiceShow);
  };
      ...
      {!newInvoiceShow && (
        <>
          <div class="invoice__header">
            <h1>Invoices</h1>
            <button onClick={() => setNewInvoiceShow(!newInvoiceShow)}>
              + New Invoice
            </button>
          </div>
